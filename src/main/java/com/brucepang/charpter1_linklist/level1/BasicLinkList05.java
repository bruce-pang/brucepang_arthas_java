...
/**
 * 构造双向链表，使用静态内部类定表示结点，实现双向链表的增加和删除元素的功能
 * @author BrucePang
 */
public class BasicLinkList05 {

    public static void main(String[] args) {
        int[] arr = {1,2,3,4,5,6};
        Node head = creatLinkedList(arr);
        // head = insertNode(head, new Node(7), 3); // 在尾部插入节点
         head = deleteNode(head, 4); // 删除最后一个节点
